---
title: "Secure Practices: Ensuring Safety While Acquiring New Applications Online"
date: 2024-08-29T19:38:09.207Z
updated: 2024-08-30T19:38:09.207Z
tags:
  - deals
categories:
  - tech
...
## Secure Practices: Ensuring Safety While Acquiring New Applications Online
...
* Avoid downloading software from mirror sites and instead use the original source or trusted app stores.
 ...
 Hackers and malware developers have been using Google search ads to [promote pages for 7-Zip, VLC Media Player, CCleaner, and other popular software](https://www.bleepingcomputer.com/news/security/hackers-push-malware-via-google-search-ads-for-vlc-7-zip-ccleaner/). The duplicate pages often look nearly identical to the actual websites, but with downloads that can harm your computer if it's not automatically detected as malware. The same method is also being used to [create fake links](https://www.anrdoezrs.net/links/3607085/type/dlg/sid/UUhtgUeUpU2001407/https://www.malwarebytes.com/blog/threat-intelligence/2022/07/google-ads-lead-to-major-malvertising-campaign) to Facebook, YouTube, and other sites. Security researchers have found malware being [promoted in Bing search ads](https://news.sophos.com/en-us/2023/07/26/into-the-tank-with-nitrogen/) as well.
...
##  Check App Stores
 ...
 Microsoft Windows has had its own app store since the Windows 8 days, now known as the [Microsoft Store](https://apps.microsoft.com/home), and the Mac App Store was introduced in 2011\. If you need to download a popular app on your Windows PC or Mac, it might be the first place you should look.

 The official app stores on Windows and macOS are generally the safest places to find and install software for your computer. Microsoft has [policies](https://learn.microsoft.com/en-us/windows/apps/publish/store-policies) and automated checks designed to block malware and other malicious software from appearing in the Microsoft Store on Windows, and Apple also has [strict requirements](https://www.apple.com/app-store/) about what can be listed in its App Store.
