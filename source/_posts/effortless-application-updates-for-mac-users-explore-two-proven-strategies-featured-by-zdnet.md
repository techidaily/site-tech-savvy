---
title: "Effortless Application Updates for Mac Users: Explore Two Proven Strategies Featured by ZDNet"
date: 2024-12-03T18:05:16.691Z
updated: 2024-12-07T00:53:43.831Z
tags:
  - apple
categories:
  - tech
...
## Apple Card Updates: Identifying Future Partners and Implications for Users

![Apple Card and iPhone](https://www.zdnet.com/a/img/resize/810f061574090b99ea4ab413606dec5f71f6f311/2023/07/26/b7746839-233d-43a6-ab88-ad3b19ed0e28/apple-card.jpg?auto=webp&width=1280)
...
**Also: [Apple names the 14 best apps and games of 2023\. Your next favorite app may be on the list](https://www.zdnet.com/article/apple-names-the-14-best-apps-and-games-of-2023/)**

However, recent developments indicate a major shift in the relationship between Apple and Goldman Sachs. Apple has [proposed terminating](https://9to5mac.com/2023/11/28/apple-ending-relationship-with-goldman-sachs-fate-of-apple-card-unclear/) its banking partnership, [including the Apple Card and Apple Card Savings Account](https://9to5mac.com/2023/11/28/apple-ending-relationship-with-goldman-sachs-fate-of-apple-card-unclear/#:~:text=Apple%20has%20also%20been%20working,partners%20such%20as%20Goldman%20Sachs), within the next 12-15 months. This decision marks a turning point in what was once seen as a groundbreaking collaboration in financial technology. 

The move is reportedly in line with Goldman Sachs' strategy to scale back its consumer finance ambitions [after incurring significant losses from the partnership](https://9to5mac.com/2023/11/28/apple-ending-relationship-with-goldman-sachs-fate-of-apple-card-unclear/). Apple, for its part, is working internally on ["Project Breakout"](https://9to5mac.com/2023/11/28/apple-ending-relationship-with-goldman-sachs-fate-of-apple-card-unclear/#:~:text=Apple%20has%20also%20been%20working,partners%20such%20as%20Goldman%20Sachs) to develop its own payment processing technology and infrastructure, aiming for greater financial independence.
...
Additionally, the card offers attractive financial incentives, including the ability to finance Apple products like iPhones and iPads over 24 months at 0% interest, alongside rewards like up to 3% cashback on purchases.

The Apple Card's standout feature is its security, underpinned by two key innovations:

* **The Secure Element (SE):** Embedded in every iPhone and Apple Watch, this specialized chip is a fortress for payment information. During transactions with Apple Pay, the SE emulates a payment card using NFC technology. This isolated, highly secure environment ensures the protection of sensitive payment data, critical in an era where digital security is paramount.
* **Tokenization Technology:** Goldman Sachs has developed a unique tokenization system for the Apple Card. It replaces the traditional credit card number (PAN) with a unique, one-time-use token for each transaction. These tokens look and function like credit card numbers but are devoid of the original PAN, making them useless to criminals and significantly reducing the risk of traditional fraud methods like skimming.
...
* **Marcus consumer banking deposits:** $100 billion, reflecting a substantial consumer banking base.
* **Personal loans:** $4.5 billion, showing Goldman's reach in consumer lending.
...
* **JPMorgan Chase (Chase):** With $1.14 trillion in assets, Chase is well-equipped for this acquisition. Its digital infrastructure and experience in tech collaborations are ideal for managing the Apple Card, including its advanced tokenization technology.
* **American Express:** Despite its $1.03 trillion asset base, American Express's unique payment network presents integration challenges with the Mastercard-based Apple Card. However, its customer service excellence and digital prowess could be beneficial.
...
* **Capital One:** With $534.5 billion in assets and a digital-first approach, Capital One could provide innovative management for the Apple Card. However, integrating the entire scope of Goldman's consumer business would be a formidable challenge.
...
How would I like this break up to shake out? I'm a Chase credit customer today with Amazon, and I have been banking with them for 30 years. I also own a Citi card as part of doing business with Costco. I'd like not to have to add another bank to my portfolio. 

American Express will have the most difficulty here because some merchants traditionally don't like taking it due to the company's payment terms. If American Express took on Apple Card, I would expect those merchants would now be encouraged to take it when they did not before, and I would also expect some new benefits (such as access to American Express lounges, etc.) for the hassle of losing a MasterCard.

**Also: [The best budgeting apps: Find the Mint alternative that's right for you](https://www.zdnet.com/article/best-budget-app/)**

Furthermore, navigating the complex regulatory environment in financial services will be vital to this transition, requiring meticulous attention to compliance and operational risk management.
...
<div><ul>
<li><a href="https://fox-friendly.techidaily.com/new-2024-approved-ultimate-streamers-guide-to-best-free-options-across-every-system/"><u>[New] 2024 Approved Ultimate Streamer's Guide to Best Free Options Across Every System</u></a></li>
