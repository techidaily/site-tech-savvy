...
## Ace Your Application: Key Strategies for Securing a Position in the Technology Department at Google - Insights From ZDNet

![A Black man in business attire smiles after getting hired. He is seated across from two interviewers who face him.](https://www.zdnet.com/a/img/resize/e02dee46f74642e6e62e5942117c421dbc862039/2022/07/18/e6c00bc4-532f-4991-8b57-9f51e31d782f/man-hired-interview-job-search.jpg?auto=webp&width=1280)
...
## What types of tech careers does Google offer?
...
You can submit your [job application](https://www.zdnet.com/education/tech-job-application-guide/) on many different websites, but Google's built-in career search tool is your best choice. Tell the company who you are, what you do, and where you want to work. You'll be matched to job postings. 

The best way to get hired anywhere is by having a referral from an employee. Ideally, this employee should have the role you're applying for. You can source referrals through LinkedIn's search feature and filter results by the current company. Brush up on your [networking](https://www.zdnet.com/education/tech-company-networking-tips/) skills and ask a current Google employee for an [informational interview](https://www.zdnet.com/education/professional-development/how-to-set-up-informational-interviews/) and discuss how they got hired. 

If you're a student or a recent graduate, you can look for an [on-campus event near you](https://buildyourfuture.withgoogle.com/events/campus-events) or participate through Google's [virtual workshops](https://careersonair.withgoogle.com/).

## What does Google look for in an ideal candidate?

While education and work experience are important, Google is looking for sharp people who can adapt to difficult situations. 

A key feature hiring managers look for is someone who can be an emergent leader who steps into leadership roles when they're needed and step back once the need is satisfied. 

Google's [Ten Things We Know To Be True](https://about.google/philosophy/) explains the company's core values. Aligning with these views in your interview could show the hiring manager you're a good fit. 
...
**SEE: [Getting an internship with a tech company: Your how-to guide](https://www.zdnet.com/education/professional-development/tech-internships/)**

---

## How to meet Google's expectations when applying for a role

When screening candidates, Google looks for applicants with unique skills, passions, and experiences. They want to make sure you're the perfect fit for Google and not just any [big tech company](https://www.zdnet.com/education/big-tech-companies-job-guide/). 

**Education background**

Google's [career section](https://careers.google.com/how-we-hire/) confirms that candidates do not need a [computer science degree](https://www.zdnet.com/education/computers-tech/best-online-computer-science-degree/) for most of their software engineering or product manager roles. Their job listings also include openings for applicants with only an associate's degree. 

Google also [hires boot camp graduates](https://www.zdnet.com/education/bootcamps/will-employers-hire-top-coding-bootcamp-graduates/) in positions across the company. Plan to continue building your skills after graduation to help your job search. 
...
Google recommends using your old resume for inspiration and starting with a blank document or [resume template](https://www.zdnet.com/education/professional-development/best-resume-templates/) to create a unique resume for each position you apply for. A [software engineer's resume](https://www.zdnet.com/education/how-to-write-a-software-engineer-resume/) should look completely different than a project manager's resume. 
...
The [hiring process](https://careers.google.com/how-we-hire/) for different roles may differ slightly but will all follow the same framework. The first stage of Google's interview process is completing an online assessment. 
...
Don't wait until you hear back from Google to prepare for your online assessment. You can practice with questions from [Leetcode's Google online assessment list](https://leetcode.com/discuss/interview-question/352460/Google-Online-Assessment-Questions). 

**Phone or video interviews**

After completing and passing an online assessment, you'll be asked to participate in a short virtual chat. You'll typically have one or two video or [phone interviews](https://www.zdnet.com/article/interview-tips-recent-grads/) to evaluate that your skills match the role. 
...
Practice the basic behavioral interview questions you typically expect to [prepare for your interview](https://www.zdnet.com/education/tech-job-interview-tips/). Brush up on skills for any skill tests or projects and rehearse answering unique questions that Google may ask. 
...
Aside from the typical ["tell me about yourself" interview question](https://www.zdnet.com/education/professional-development/tell-me-about-yourself-interview-question/), Google may also ask unique questions similar to these examples: 
...
You can also expect Google's hiring manager to ask [behavioral interview questions](https://www.zdnet.com/education/professional-development/behavioral-interview-questions/) similar to these: 
